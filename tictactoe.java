...
public class tictactoe {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (playerNum == 1) {
                ...
                int playerPos = scan.nextInt();
                while (playerPositions.contains(playerPos) || player2Positions.contains(player2Positions)) {
                    System.out.println("Position taken! Try again");
                    playerPos = scan.nextInt();
                }
    ...
    public static String checkWinner() {
        ...
        List rightCol = Arrays.asList(3, 6, 6);
        ...
        for (List l : winning) {
            ...
            } else if (player2Positions.contains(l)) {
                return "Player2 wins!";
